      ...
      <div className="w-full max-w-[1440px] flex-1 bg-brand-bg rounded-[20px] border border-brand-hero/10 shadow-sm overflow-hidden flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center pt-16 px-12 text-center pb-40">
          ...
          <div className="max-w-[800px] mx-auto mb-8">
            <h1 className="text-[64px] font-medium leading-[1.1] tracking-[-2px] text-brand-primary text-balance">
          ...
          <div className="max-w-[540px] mx-auto mb-10">
            <p className="text-[18px] font-medium leading-[26px] text-brand-hero/80 text-balance">
          ...
          {/* Download Button */}
          <Button href="https://apps.apple.com/us/app/olive-holistic-food-scanner/id6739765789" className="gap-2.5 px-8 py-4 mb-20 bg-[#1A1A1A] hover:bg-black transition-all">
